...
/***/ (function(module, exports, __webpack_require__) {
	...
	/* WEBPACK VAR INJECTION */(function($) {// code from the following commit:
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var choreEvents = __webpack_require__(12);
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var onCreateChore = function onCreateChore(event) {
	  event.preventDefault();
	  var data = getFormFields(event.target);
	  api.createChore(data).then(ui.createChoreSuccess).catch(ui.createChoreFailure);
	};
	...
	var onShowAllChores = function onShowAllChores(event) {
	  event.preventDefault();
	  var data = getFormFields(event.target);
	  api.showAllChores().then(ui.showChoreSuccess).catch(ui.showChoreFailure);
	};
	...
	var onUpdateChore = function onUpdateChore(event) {
	  ...
	  var choreNumber = data.chores.chore.id;
	  var choreObject = data.chores;
	  api.updateChore(choreObject, choreNumber).then(ui.updateChoreSuccess).catch(ui.updateChoreFailure);
	};
	...
	var onDeleteChore = function onDeleteChore(event) {
	  ...
	  // debugger;
	  );api.deleteChore(id.chore.id).then(ui.deleteChoreSuccess).catch(ui.deleteChoreFailure);
	};
	...
	module.exports = {
	  ...
	  onShowAllChores: onShowAllChores,
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var showAllChores = function showAllChores() {
	  return $.ajax({
	    url: config.apiOrigin + '/chores/',
	    method: 'GET',
	    headers: {
	...
	var updateChore = function updateChore(choreObject, choreNumber) {
	  // debugger
	  return $.ajax({
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var showChoresTemplate = __webpack_require__(15);
	var store = __webpack_require__(5
	...
	var createChoreSuccess = function createChoreSuccess(response) {
	...
	var createChoreFailure = function createChoreFailure(response) {
	  $('#usermessages').text('Adding a chore failed. Try again.');
	};

	// Chore show

	var validateChoreShow = function validateChoreShow(response) {
	...
	var showChoreSuccess = function showChoreSuccess(response) {
	  ...
	  if (store.chores == '') {
	    ...
	    $('#chore-list').show();
	    var showChoreList = showChoresTemplate({ chores: store.chores });
	...
	var updateChoreSuccess = function updateChoreSuccess(response) {
	...
	var updateChoreFailure = function updateChoreFailure(response) {
	  $('#usermessages').text('Updating a chore failed. Try again?');
	};

	// Chore Delete

	var deleteChoreSuccess = function deleteChoreSuccess(response) {
	...
	var deleteChoreFailure = function deleteChoreFailure(response) {
	...
	module.exports = {
	  ...
	  validateChoreShow: validateChoreShow,
	  showChoreSuccess: showChoreSuccess,
...
/***/ (function(module, exports, __webpack_require__) {
	...
	module.exports = (Handlebars["default"] || Handlebars).template({"1":function(container,depth0,helpers,partials,data,blockParams) {
	  ...
	  return "\n<div class=\"container\">\n  <!-- change back to row below -->\n<div class=\"row\">\n  <div class=\"col-lg-4 col-md-4 col-sm-12 col-xs-12\">\n    <div class=\"thumbnail\">\n      <div class=\"caption\">\n<div id='chore-listing' data-id=\""
	    ...
	    + "</p>\n  <p>Day of Week: "
	    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.day_of_week : stack1), depth0))
	    + "</p>\n</div>\n</div>\n</div>\n</div>\n\n";
